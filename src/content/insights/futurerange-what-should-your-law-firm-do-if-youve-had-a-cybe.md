---
title: "What Should Your Law Firm Do if You’ve Had a Cyber Breach?"
description: "Irish law firms are facing a sharp rise in cyber attacks — these are the vital steps your firm should take immediately after discovering a data breach or ransomware incident."
category: 'Cybersecurity'
date: 2022-11-02
---

*Originally published by [FutureRange](https://web.archive.org/web/20221204185939/https://futurerange.ie/blog/what-should-your-law-firm-do-if-youve-had-a-cyber-breach/).*

It’s estimated that there has been a [50% jump](https://www.cybersecurity-insiders.com/survey-says-cyber-attacks-on-irish-law-firms-has-increased/) in these attacks over the past 12 months. During that time, 4 out of 10 Irish law firms experienced downtime as a result of a cyber attack.

Without a good [cybersecurity strategy](https://futurerange.ie/services/security/), these legal offices can suffer serious costs, including remediation of the security breach, reputation damage, and data privacy compliance penalties.

The steps you take after a breach can either increase or reduce the impact. Not having a [cybersecurity response](https://futurerange.ie/blog/7-advantages-of-using-the-24-7-monitoring-solution-for-cyber-security/) plan can lead to you paying much higher costs due to a delayed reaction.

IBM Security estimates that the global average cost for a data breach is [€4.43 million](https://www.ibm.com/reports/data-breach). But organisations with a tested incident response plan can reduce that by €2.71 million, a savings of 39%.
...
Many types of malware are designed to spread throughout a network as fast as possible. This is especially true for [ransomware](https://futurerange.ie/services/security/cybersecurity-compliance/ransomware-prevention/), which locks users out of their files through the use of encryption.
...
You will need to review the data privacy regulations that your law office is subject to, such as GDPR, and make notifications to third parties according to [the guidelines](https://www2.deloitte.com/ch/en/pages/risk/articles/gdpr-security-and-breach-notification.html). If notification isn’t made in a timely manner, it can lead to penalties, as well as a significant loss of trust in your business by those you need to contact.
